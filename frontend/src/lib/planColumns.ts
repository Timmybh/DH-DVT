...
export const PLANNED_COLS: Col<PlanRowDto>[] = [
  ...
  { key: "sot", label: "SOT", w: 60, kind: "num", get: (r) => r.calc?.sot },
  { key: "total_sot", label: "Total SOT", w: 76, kind: "num", get: (r) => r.calc?.total_sot },
  { key: "lead_days", label: "Lead days", w: 70, kind: "num", get: (r) => ref(r).lead_days },
  ...
  { key: "output", label: "Output date", w: 88, kind: "date", get: (r) => r.calc?.output_date },
  { key: "end_prod", label: "End prod date", w: 92, kind: "date", get: (r) => r.calc?.end_prod_date },
