...
from app.api import actual, admin, auth, calendar_rules, erp_qtcn_sync, snapshots, so, dashboard, dashboard_admin, formulas, lifecycle, monitoring, planning, resources, sync, technology_process, theme
...
for module in (auth, admin, sync, dashboard, dashboard_admin, planning, formulas, resources, actual, lifecycle, monitoring, theme, calendar_rules, snapshots, so, technology_process, erp_qtcn_sync):
